...
class Category(models.Model):
    ...
    class Meta:
        verbose_name_plural = "分类"  # 显示在admin中的管理标签

    def __unicode__(self):
        return self.label

class CategoryAdmin(admin.ModelAdmin):
    prepopulated_fields = {'slug': ('label',)} #自动填充数据
...
class Story(models.Model):
    ...
    admin_objects = models.Manager()  # 管理所有内容
    objects = ViewableManager() #页面过滤
