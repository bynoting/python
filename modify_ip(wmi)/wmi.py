  ...
  def __init__ (self, ole_object, instance_of=None, fields=[]):
    try:
      ...
      for q in self.ole_object.Qualifiers_:
        self.qualifiers[q.Name] = q.Value
      _set (self, "is_association", ("Association") in self.qualifiers ) # self.qualifiers.has_key ("Association"))
...
class _wmi_namespace:
  ...
  def _raw_query (self, wql):
    ...
    except pywintypes.com_error as hresult:#, hresult_text ,additional ,param_in_error :
